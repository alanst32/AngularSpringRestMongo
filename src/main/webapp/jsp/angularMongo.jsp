...
<!-- CUSTOM -->
<script src="resources/jsRocket/angularMongo.js"></script>

</head>
<body ng-app="myApp" ng-controller="dashboardCtrl as vm">
<div class="container">
	<h2>Example Angular (Bootstrap), DataTables, Spring, REST, MongoDB</h2>
	...
	<form class="form-horizontal" role="form">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<div class="input-group date" id="pickerDateBirth">
					<input type="text" class="form-control" placeholder="dd/MM/yyyy" id="dataB" ng-model="vm.dateBirth">
		...
		<div class="form-group">
			<button type="button" class="btn btn-info" ng-model="vm.buttonSearch" ng-click="vm.callSearch()">
				<span class="glyphicon glyphicon-search"></span> Search
			</button>
			<button type="button" class="btn btn-success" ng-model="vm.buttonInsert" ng-click="vm.callInsert()">
				<span class="glyphicon glyphicon-plus-sign"></span> Insert
			</button>
			<button type="button" class="btn btn-warning" ng-model="vm.buttonDelete" ng-click="vm.callDelete()">
				<span class="glyphicon glyphicon-minus-sign"></span> Delete
			</button>
		</div>
		<div>
		<table width="100%" datatable="" class="row-border hover" dt-options="vm.dtOptions" dt-column-defs="vm.dtColumnDefs"
